...
import static com.adadeh.tugas6.DBmain.TABLENAME;



import com.adadeh.tugas6.databinding.ActivityMain6Binding;
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_cuaca) {
                    Intent a = new Intent(MainActivity6.this, MainActivity.class);
                    startActivity(a);}
                else if (id == R.id.nav_setting) {
                    Intent a = new Intent(MainActivity6.this, MainActivity2.class);
                    startActivity(a);
                } else if (id == R.id.nav_profile) {
                    Intent a = new Intent(MainActivity6.this, MainActivity3.class);
                    startActivity(a);
                }else if (id == R.id.nav_Alarm) {
                    Intent a = new Intent(MainActivity6.this, MainActivity4.class);
                    startActivity(a);
                }else if (id == R.id.nav_Sqlite) {
                    Intent a = new Intent(MainActivity6.this, MainActivity6.class);
                    startActivity(a);
                }else if (id == R.id.nav_Wheater) {
                    Intent a = new Intent(MainActivity6.this, ApiActivity.class);
                    startActivity(a);
                }
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
                                                         ...
                                                         public void onClick(View v) {
                                                             ...
                                                             if (rec != null) {
                                                                 Toast.makeText(MainActivity6.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                                                                 ...
                                                                 Toast.makeText(MainActivity6.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                                                             }
                                                         }
                                                     });
        //for view display
        binding.btnDisplay.setOnClickListener(new
                                                      View.OnClickListener() {
                                                          @Override
                                                          public void onClick(View v) {
                                                              startActivity(new Intent( MainActivity6.this,
                                                                      DisplayData.class));
                                                          }
                                                      });
        //for storing new data or update data
        binding.btnEdit.setOnClickListener(new
                                                   View.OnClickListener() {
                                                       @Override
                                                       public void onClick(View v) {
                                                           ContentValues cv = new ContentValues();
                                                           ...
                                                           if(recedit != -1){
                                                               Toast.makeText(MainActivity6.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
                                                               ...
                                                               Intent a = new Intent(MainActivity6.this,
                                                                       DisplayData.class);
                                                               startActivity(a);
                                                           }
                                                       }
